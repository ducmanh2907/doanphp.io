...
require_once __DIR__ . "/../../models/AdminCartModel.php";
...
<?php if (count($cartItems) > 0): ?>
    <table>
        ...
        <?php foreach ($cartItems as $item): ?>
            <tr>
                ...
                <td>
                    <a href="/webbanhang/app/admin/index.php?controller=admincart&action=remove&id=<?php echo $item['id']; ?>">Xóa</a>
                </td>
            </tr>
        <?php endforeach; ?>
    </table>
   ...
   <form method="POST" action="/webbanhang/app/admin/index.php?controller=adminorder&action=checkout">
